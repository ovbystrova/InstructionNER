...
class TestReader(TestCase):
    ...
    @parameterized.expand([
        ("SOCCER - JAPAN GET LUCKY WIN , CHINA IN SURPRISE DEFEAT .", [(9, 14, "LOC"), (31, 36, "LOC")], "en",
         "JAPAN is a LOC, CHINA is a LOC."),
        ("Bitar pulled off fine saves whenever they did .", [(0, 5, "PER")], "en",
         "Bitar is a PER.")
    ])
    ...
    @parameterized.expand([
        ("AL-AIN , United Arab Emirates 1996-12-06", [(0, 6, "LOC"), (9, 29, "LOC")], "ru")
    ])
    def test_raise_error_when_wrong_language(
        ...
        self.assertRaises(
            ValueError,
            AnswerFormatter.from_spans,
            context, entity_spans, language
        )

    @parameterized.expand([
        ({"LOC": ["JAPAN"], "PER": ["CHINA"]}, "en",
    ...
    @parameterized.expand([
        ("SOCCER - JAPAN GET LUCKY WIN , CHINA IN SURPRISE DEFEAT .", "Please extract entities",
         "Sentence: SOCCER - JAPAN GET LUCKY WIN , CHINA IN SURPRISE DEFEAT . "
         "Instruction: Please extract entities EMPTY."),
        ("Bitar pulled off fine saves whenever they did .", "Please please extract entity words",
         "Sentence: Bitar pulled off fine saves whenever they did . "
